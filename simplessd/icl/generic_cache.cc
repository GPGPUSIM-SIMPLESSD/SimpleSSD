...
//updated
  temp.name = prefix + "generic_cach.cachelines_read";
  temp.desc = "Number of cachelines fetched due to read";
  list.push_back(temp);

  temp.name = prefix + "generic_cache.cachelines_write";
  temp.desc = "Number of cachelines fetched due to write";
  list.push_back(temp);

  temp.name = prefix + "generic_cache.cache_read_miss";
  temp.desc = "Cache miss due to read";
  list.push_back(temp);

  temp.name = prefix + "generic_cache.cache_write_miss";
  temp.desc = "Cache miss due to write";
  list.push_back(temp);

  temp.name = prefix + "generic_cache.cache_read_hit";
  temp.desc = "Cache hit due to read";
  list.push_back(temp);

  temp.name = prefix + "generic_cache.cache_write_hit";
  temp.desc = "cache hit due to write";
  list.push_back(temp);

  temp.name = prefix + "generic_cache.cache_flush";
  temp.desc = "Number of times cache flushed";
  list.push_back(temp);

  temp.name = prefix + "generic_cache.cache_evicted";
  temp.desc = "Number of times cache eviction occured";
  list.push_back(temp);
}
...
void GenericCache::getStatValues(std::vector<double> &values) {
  ...
  values.push_back(stat.cachelines_read);
  values.push_back(stat.cachelines_write);
  values.push_back(stat.cache_read_miss);
  values.push_back(stat.cache_write_miss);
  values.push_back(stat.cache_read_hit);
  values.push_back(stat.cache_write_hit);
  values.push_back(stat.cache_flush);
  values.push_back(stat.cache_evicted);
